...
import numpy as np
from clr import *
from System import Array, Convert, Double, Int64, IntPtr, Random
...
class TL_SDK(object):
    ...
    def get_number_of_cameras(self):
        ...
        try:
            ...
            raise SDKExceptionError(
                "Error: could not get number of cameras\n" + str(tie)
            )
        except Exception as e:
    ...
    def open_camera(self, camera_id):
        ...
        try:
            ...
            raise SDKExceptionError(
                "Error: could not open camera " + str(camera_id) + "\n" + str(ioe)
            )
    ...
    def open_camera_only(self, camera_id):
        ...
        try:
            ...
            raise SDKExceptionError(
                "Error: could not open camera; {exception}\n".format(
                    exception=exception
                )
            )
        return retval
...
class TL_Camera(object):
    ...
    def close(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not close camera; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def arm(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not arm camera; {exception}\n".format(exception=exception)
            )
    ...
    def disarm(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not disarm camera; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def set_frames_per_trigger_zero_for_unlimited(self, num_frames):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set Frames Per Trigger; {exception}\n".format(
                    exception=exception
                )
            )

    def set_is_frame_rate_controlled(self, enabled=True):
        try:
            self.camera.IsFrameRateControlEnabled = enabled
        except Exception as exception:
            raise CameraExceptionError(
                "Error: could not set Frames Per Trigger; {exception}\n".format(
                    exception=exception
    ...
    def set_frame_rate_fps(self, fps):
        try:
            self.camera.FrameRateControlValue_fps = fps
        except Exception as exception:
            raise CameraExceptionError(
                "Error: could not set Frames Per Trigger; {exception}\n".format(
                    exception=exception
    ...
    def set_maximum_number_of_frames_to_queue(self, num_frames):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set max number of frames to queue; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def issue_software_trigger(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: IssueSoftwareTrigger failed; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def get_pending_frame_or_null(self):
        ...
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get pending frame;{exception}\n".format(exception=e)
            )
        return retval
    ...
    def frame_to_array(frame) -> np.ndarray:
        ...
        try:
            image = Convert.ChangeType(
                frame.ImageData, thorlabs_tsi_imagedata.ImageDataUShort1D
            ).ImageData_monoOrBGR
            ...
            Marshal.Copy(
                image, 0, IntPtr(ret_array.__array_interface__["data"][0]), len(image)
            )  # .NET method that copies image ( a System.UInt16[] type ) memory to ret_array ( an np array dtype = uint16 ) 'data' memory
            ret_array = ret_array.reshape(
                frame.get_ImageData().get_Height_pixels(),
            ...
            raise CameraExceptionError(
                "Error: could not convert frame to array - index out of bounds\n" + ie
            )
        except Exception as e:
            print("Error converting frame to array")
            raise CameraExceptionError(
                "Error: could not convert frame to array:\n" + str(e)
            )
        # finally:
    ...
    def set_exposure_time_us(self, time_ms):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set exposure time; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def set_gain(self, gain):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set gain; {exception}\n".format(exception=exception)
            )
    ...
    def set_black_level(self, blacklevel):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set black level; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def get_black_level_range(self):
        try:
            return (
                self.camera.BlackLevelRange.Minimum,
                self.camera.BlackLevelRange.Maximum,
            )
        except Exception as exception:
            raise CameraExceptionError(
                "Error: could not get black level range; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def get_gain_range(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get gain range; {exception}\n".format(
                    exception=exception
                )
            )
    ...
    def get_sensor_width_pixels(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get sensor width; {error}\n".format(error=exception)
            )
    ...
    def get_sensor_height_pixels(self):
        ...
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get sensor height; {exception}\n".format(
                    exception=exception
                )
            )
        return retval
    ...
    def get_bit_depth(self):
        ...
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get bit depth; {exception}\n".format(
                    exception=exception
                )
            )
        return retval
    ...
    def add_on_image_frame_available_callback(self, callback, *args):
        try:
            if len(args) == 0:
                ...
                self.camera.OnImageFrameAvailable += lambda source, eventargs: callback(
                    source, eventargs, *args
                )  # one could pass any number of arguments to their callback
        except:
            raise CameraExceptionError(
                "Error: could not set image frame available callback\n"
            )

    def remove_on_image_frame_available_callback(self, callback):
        self.camera.OnImageFrameAvailable -= (
            callback  # TODO: works with variadic\lambda?
        )
    ...
    def set_is_tap_balance_enabled(self, tap_balance_enabled):
        try:
            ...
            raise CameraExceptionError(
                "Error: SetIsTapBalanceEnabled failed\n" + str(be)
            )
    ...
    def get_is_tap_balance_enabled(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: GetIsTapBalanceEnabled failed\n" + str(be)
            )
    ...
    def tap_balance_load_data_from_file(self, file):
        try:
            ...
            raise SDKExceptionError(
                "Error: Tap balance data could not be loaded from file\n" + str(e)
            )
    ...
    def tap_balance_write_data_to_camera(self):
        try:
            ...
            raise SDKExceptionError(
                "Error: Tap balance data could not be written to camera\n" + str(e)
            )
    ...
    def set_hot_pixel_correction_threshold(self, threshold):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set hot pixel correction threshold " + str(e)
            )
    ...
    def get_hot_pixel_correction_threshold(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get hot pixel correction threshold " + str(e)
            )
    ...
    def set_is_hot_pixel_correction_enabled(self, is_enabled):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set IsHotPixelCorrectionEnabled " + str(e)
            )
    ...
    def get_is_hot_pixel_correction_enabled(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get IsHotPixelCorrectionEnabled " + str(e)
            )
    ...
    def set_is_cooling_enabled(self, is_enabled):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not set IsCoolingEnabled " + str(e)
            )
    ...
    def get_is_cooling_enabled(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get IsCoolingEnabled " + str(e)
            )
    ...
    def get_sensor_height_range(self):
        try:
            return (
                self.camera.SensorHeight_pixels.Minimum,
                self.camera.SensorHeight_pixels.Maximum,
            )
        except Exception as e:
    ...
    def get_sensor_width_range(self):
        try:
            return (
                self.camera.SensorWidth_pixels.Minimum,
                self.camera.SensorWidth_pixels.Maximum,
            )
        except Exception as e:
    ...
    def free_all_but_given_number_of_frames(
        self, number_of_frames_to_leave_in_queue: int
    ):
        try:
            self.camera.FreeAllButGivenNumberOfFrames(
                number_of_frames_to_leave_in_queue
            )
        except Exception as exception:
            raise CameraExceptionError(
                "Unable to free all but given number of frames; {error}".format(
                    error=exception
                )
            )
    ...
    def get_image_width(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get image width; {error}".format(error=e)
            )
    ...
    def get_image_height(self):
        try:
            ...
            raise CameraExceptionError(
                "Error: could not get image height; {error}".format(error=e)
            )
    ...
    def get_autoscaled_image(self, image):
        try:
            ...
            raise SDKExceptionError(
                "unable to autoscale image; {error}".format(error=exception)
            )
    ...
    def get_color_filter_array_type(self):
        try:
            ...
            if self.camera.ColorFilterArrayPhase == ColorFilterArrayPhase.BayerBlue:
                return "blue"
            if (
                self.camera.ColorFilterArrayPhase
                == ColorFilterArrayPhase.BayerGreenLeftOfRed
            ):
                return "green left of red"
            if (
                self.camera.ColorFilterArrayPhase
                == ColorFilterArrayPhase.BayerGreenLeftOfBlue
            ):
